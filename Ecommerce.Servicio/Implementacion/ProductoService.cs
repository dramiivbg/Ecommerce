...
namespace Ecommerce.Servicio.Implementacion
{
    public class ProductoService: IProductoService
    {
        ...
        public ProductoService(IGenericoRepositorio<Producto> modeloRepositorio, IMapper mapper)
        {
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                if (fromDbMdelo != null)
                {
                    fromDbMdelo.IdCategoria =  modelo.IdCategoria;
                    fromDbMdelo.Nombre = modelo.Nombre;
                    fromDbMdelo.Descripcion = modelo.Descripcion;
                    fromDbMdelo.Imagen = modelo.Imagen;
                    fromDbMdelo.Precio = modelo.Precio;
                    fromDbMdelo.PrecioOferta = modelo.PrecioOferta;
                    fromDbMdelo.Cantidad = modelo.Cantidad;
        ...
        public async Task<List<ProductoDTO>> Lista(string buscar)
        {
            ...
            {
                var consulta = _modeloRepositorio.Consultar(p =>
                p.Nombre!.Contains(buscar.ToLower())
                );
